...
class TestQueryParserBase(unittest.TestCase):
    ...
    def _getTargetClass(self):
        from hypatia.indexes.text.queryparser import QueryParser
        return QueryParser
    ...
    def _failure(self, parser, input):
        from hypatia.indexes.text.parsetree import ParseError
    ...
    def _compareParseTrees(self, got, expected, msg=None):
        from hypatia.indexes.text.parsetree import AndNode
        from hypatia.indexes.text.parsetree import AtomNode
        from hypatia.indexes.text.parsetree import GlobNode
        from hypatia.indexes.text.parsetree import NotNode
        from hypatia.indexes.text.parsetree import OrNode
        from hypatia.indexes.text.parsetree import ParseTreeNode
        from hypatia.indexes.text.parsetree import PhraseNode
        if msg is None:
            msg = repr(got)
...
class TestQueryParser(TestQueryParserBase):
    ...
    def test_class_conforms_to_IQueryParser(self):
        ...
        from hypatia.indexes.text.interfaces import IQueryParser
