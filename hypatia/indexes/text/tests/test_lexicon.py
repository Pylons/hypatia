...
class LexiconTests(unittest.TestCase):
    ...
    def test_class_conforms_to_ILexicon(self):
        ...
        from hypatia.indexes.text.interfaces import ILexicon
...
class SplitterTests(unittest.TestCase):
    ...
    def test_class_conforms_to_ISplitter(self):
        from zope.interface.verify import verifyClass
        from hypatia.indexes.text.interfaces import ISplitter
...
class CaseNormalizerTests(unittest.TestCase):
    ...
    def test_class_conforms_to_IPipelineElement(self):
        from zope.interface.verify import verifyClass
        from hypatia.indexes.text.interfaces import IPipelineElement
...
class StopWordAndSingleCharRemoverTests(unittest.TestCase):
    ...
    def _getTargetClass(self):
        from hypatia.indexes.text.lexicon import StopWordAndSingleCharRemover
